...
As a result, the dashboard will look as follows:

![hw](Images/myDashboard.png)
...
* Use `console.log` inside of JavaScript code to see what data looks like at each step.
